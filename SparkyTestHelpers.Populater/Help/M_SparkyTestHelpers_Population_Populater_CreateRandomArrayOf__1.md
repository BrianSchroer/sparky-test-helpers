# Populater.CreateRandomArrayOf(*T*) Method 
 

Create array of *T* and populate with random test data.
...
**C#**<br />
``` C#
public virtual T[] CreateRandomArrayOf<T>(
	int count,
