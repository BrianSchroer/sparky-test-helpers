# GetRandom.DateTime Method 
 

Get random DateTime(RandomValueProvider) value.
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/03ybds8y" target="_blank">DateTime</a><br />Random DateTime(RandomValueProvider) value.
