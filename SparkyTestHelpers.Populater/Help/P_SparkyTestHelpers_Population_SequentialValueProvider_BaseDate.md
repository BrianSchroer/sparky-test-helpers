# SequentialValueProvider.BaseDate Property 
 

Base date to be used for populating <a href="http://msdn2.microsoft.com/en-us/library/03ybds8y" target="_blank">DateTime</a> properties.
