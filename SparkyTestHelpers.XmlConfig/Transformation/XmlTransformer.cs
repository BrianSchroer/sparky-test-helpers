...
namespace SparkyTestHelpers.XmlConfig.Transformation
{
    ...
    public class XmlTransformer
    {
        ...
        /// </summary>
        /// <param name="possiblePaths">Path(s) where the base XML file might be found.</param>
        ...
        /// </summary>
        /// <param name="possiblePaths">Path(s) where the transform XML file might be found.</param>
