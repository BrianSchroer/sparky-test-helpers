...
namespace SparkyTestHelpers.NonPublic
{
    ...
    /// </summary>
    /// <remarks>
    /// Copied from Microsoft.VisualStudio.TestTools.UnitTesting.PrivateObject.
    /// https://github.com/microsoft/testfx
    /// </remarks>
    public class NonPublicMembers<T>
    {
        #region Data
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NonPublicMembers"/> class that contains
        ...
        public NonPublicMembers(T obj, string memberToAccess)
        {
            Helper.CheckParameterNotNull(obj, "obj", string.Empty);
            ValidateAccessString(memberToAccess);

            NonPublicMembers<T> temp = obj as NonPublicMembers<T>;
            if (temp == null)
            {
                temp = new NonPublicMembers<T>(obj);
            }
            ...
            for (int i = 0; i < arr.Length; i++)
            {
                ...
                temp = new NonPublicMembers<T>(next);
            }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NonPublicMembers"/> class that wraps the
        /// specified type.
        /// </summary>
        /// <param name="assemblyName">Name of the assembly</param>
        /// <param name="typeName">fully qualified name</param>
        /// <param name="args">Arguments to pass to the constructor</param>
        public NonPublicMembers(string assemblyName, string typeName, params object[] args)
        ...
        /// <param name="args">Arguments to pass to the constructor</param>
        public NonPublicMembers(string assemblyName, string typeName, Type[] parameterTypes, object[] args)
        ...
        /// <param name="args">Arguments to pass to the constructor</param>
        public NonPublicMembers(Type type, params object[] args)
            : this(type, null, args)
        {
        ...
        /// <param name="parameterTypes">An array of <see cref="T:System.Type"/> objects representing the number, order, and type of the parameters for the constructor to get</param>
        /// <param name="args">Arguments to pass to the constructor</param>
        public NonPublicMembers(Type type, Type[] parameterTypes, object[] args)
        {
            Helper.CheckParameterNotNull(type, "type", string.Empty);
            object o;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NonPublicMembers"/> class that wraps
        /// the given object.
        /// </summary>
        /// <param name="obj">object to wrap</param>
        [SuppressMessage("Microsoft.Naming", "CA1720:IdentifiersShouldNotContainTypeNames", MessageId = "obj", Justification = "We don't know anything about the object other than that it's an object, so 'obj' seems reasonable")]
        public NonPublicMembers(object obj)
        {
            Helper.CheckParameterNotNull(obj, "obj", string.Empty);
        ...
        /// </summary>
        /// <param name="obj">object to wrap</param>
        /// <param name="type"><see cref="NonPublicMembersType" /> object</param>
        [SuppressMessage("Microsoft.Naming", "CA1720:IdentifiersShouldNotContainTypeNames", MessageId = "obj", Justification = "We don't know anything about the object other than that it's an object, so 'obj' seems reasonable")]
        public NonPublicMembers(object obj, NonPublicMembersType type)
        {
            Helper.CheckParameterNotNull(type, "type", string.Empty);
            this.target = obj;
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                Debug.Assert(this.target != null, "target should not be null.");
                if (typeof(NonPublicMembers<T>) == obj?.GetType())
                {
                    return this.target.Equals(((NonPublicMembers<T>)obj).target);
                }
                else
                {
                    return false;
