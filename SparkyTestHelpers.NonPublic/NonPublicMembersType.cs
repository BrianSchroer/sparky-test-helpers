...
namespace SparkyTestHelpers.NonPublic
{
    ...
    /// </summary>
    /// <remarks>
    /// Copied from Microsoft.VisualStudio.TestTools.UnitTesting.PrivateType (https://github.com/microsoft/testfx)
    /// </remarks>
    public class NonPublicMembersType
    {
        /// <summary>
        /// Binds to everything
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NonPublicMembersType"/> class that contains the private type.
        /// </summary>
        /// <param name="assemblyName">Assembly name</param>
        /// <param name="typeName">fully qualified name of the </param>
        public NonPublicMembersType(string assemblyName, string typeName)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NonPublicMembersType"/> class that contains
        /// the private type from the type object
        /// </summary>
        /// <param name="type">The wrapped Type to create.</param>
        public NonPublicMembersType(Type type)
        {
            if (type == null)
            {
